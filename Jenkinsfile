...
stage('Docker Build') {
    agent any
      steps {
        ...
        sh 'docker tag  jed.ocir.io/axnfm4jb3i73/groundx_fe_uat_an jed.ocir.io/axnfm4jb3i73/groundx_fe_uat_an:v21707.2'
	sh 'docker push jed.ocir.io/axnfm4jb3i73/groundx_fe_uat_an:v21707.2'

...
export class LandingPageComponent implements OnInit {
  ...
  getFavouriteCollection(favouriteUid: string) {
    ...
    const headers = { 'enrichers-document': ['thumbnail', 'renditions', 'favorites', 'tags', "permissions","audit"], 'fetch.document': 'properties', properties: '*' };
  ...
  getTasks() {
    ...
    const headers = { 'enrichers-document': ['thumbnail', 'renditions', 'favorites', 'tags', "permissions","audit"], 'fetch-task': 'targetDocumentIds,actors', properties: 'dublincore,common,file,uid' };
  ...
  getCollections() {
    ...
    const headers = { 'enrichers-document': ['thumbnail', 'renditions', 'favorites', "permissions","audit"], 'fetch-task': 'targetDocumentIds,actors', properties: 'dublincore,common,file,uid' };
  ...
  getEdited() {
    ...
    const headers = { 'enrichers-document': ['thumbnail', 'renditions', 'favorites', 'tags', "permissions","audit"], 'fetch.document': 'properties', properties: '*', 'fetch-task': 'actors' };
